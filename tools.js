...
class Tools {
	...
	pairs (Raw) {
		...
		let Pairs = [{
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42258.67, 42318.05]],
			ts_a: new Date(`2024-01-29 14:19`).valueOf(), 
			ts_z: new Date(`2024-01-29 14:35`).valueOf()
		}/*, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42286.54, 42324.40]],
			ts_a: new Date(`2024-01-29 13:58`).valueOf(), 
			ts_z: new Date(`2024-01-29 14:12`).valueOf()
		}/*, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42334.25, 42344.25]],
			ts_a: new Date(`2024-01-28 19:04`).valueOf(), 
			ts_z: new Date(`2024-01-28 19:05`).valueOf()
		}/*, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42604.00, 42611.00]],
			ts_a: new Date(`2024-01-28 13:13`).valueOf(), 
			ts_z: new Date(`2024-01-28 13:15`).valueOf()
		}/*, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42572.10, 42599.76]],
			ts_a: new Date(`2024-01-28 12:32`).valueOf(), 
			ts_z: new Date(`2024-01-28 12:34`).valueOf()
		}/*, {
			gas: 7.5/100,
