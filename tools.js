...
class Tools {
	...
	values (Raw) {
		...
		let Pairs = [
			...
			{pair: [[`eur`, `usd`], [0, 1.07049]]}, 
			{pair: [[`jpy`, `usd`], [0, .0063540]]},
			{pair: [[`kes`, `usd`], [0, .0077398]]},
			{pair: [[`nok`, `usd`], [0, .093604]]},
			{pair: [[`nzd`, `usd`], [0, .61436]]}, 
			{pair: [[`zar`, `usd`], [0, .054384]]}, 
			{pair: [[`sek`, `usd`], [0, .095068]]},
			{pair: [[`gbp`, `usd`], [0, 1.26856]]}, 
			{pair: [[`chf`, `usd`], [0, 1.12364]]},
