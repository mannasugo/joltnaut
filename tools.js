...
class Tools {
	...
	pairs (Raw) {
		...
		let Pairs = [{
			gas: 7.5/100,
			pair: [`btc/fdusd`, [39920.70, 39937.70]],
			ts_a: new Date(`2024-01-24 17:25`).valueOf(), 
			ts_z: new Date(`2024-01-24 17:26`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [40127.15, 40148.84]],
			ts_a: new Date(`2024-01-24 17:40`).valueOf(), 
			ts_z: new Date(`2024-01-24 17:41`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [39919.19, 39946.753]],
			ts_a: new Date(`2024-01-24 18:03`).valueOf(), 
			ts_z: new Date(`2024-01-24 18:04`).valueOf()
		}/*, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [38629.28, 38661.29]],
			ts_a: new Date(`2024-01-23 17:19`).valueOf(), 
			ts_z: new Date(`2024-01-23 17:24`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [38920.00, 38938.66]],
			ts_a: new Date(`2024-01-23 18:07`).valueOf(), 
			ts_z: new Date(`2024-01-23 18:08`).valueOf()
		}/*, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [44099.70, 44233.23]],
			ts_a: new Date(`2024-01-07 22:15`).valueOf(), 
			ts_z: new Date(`2024-01-07 23:00`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [44173.88, 44233.23]],
			ts_a: new Date(`2024-01-08 00:42`).valueOf(), 
			ts_z: new Date(`2024-01-08 01:00`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [43732.59, 43920.91]],
			ts_a: new Date(`2024-01-08 02:42`).valueOf(), 
			ts_z: new Date(`2024-01-08 03:06`).valueOf()
		}/*, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [43029.52, 43145.25]],
			ts_a: new Date(`2024-01-04 10:24`).valueOf(), 
			ts_z: new Date(`2024-01-04 10:33`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42455.78, 42669.43]],
			ts_a: new Date(`2023-12-29 06:18`).valueOf(), 
			ts_z: new Date(`2023-12-29 06:39`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42542.95, 42636.42]],
			ts_a: new Date(`2023-12-29 08:24`).valueOf(), 
			ts_z: new Date(`2023-12-29 09:36`).valueOf()
		}, {
			gas: 7.5/100,
			pair: [`btc/fdusd`, [42284.56, 42362.46]],
