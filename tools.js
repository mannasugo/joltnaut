...
class Tools {
	...
	values (Raw) {
		...
		let Pairs = [
			{pair: [[`btc`, `usd`], [0, 69345.37]]}, 
			{pair: [[`eth`, `usd`], [0, 3691.92]]}, 
			{pair: [[`ltc`, `usd`], [0, 79.99]]}, 
			{pair: [[`usdt`, `usd`], [0, .9998]]}, 
			{pair: [[`xmr`, `usd`], [0, 171.0575]]}, 
			{pair: [[`xrp`, `usd`], [0, .04952]]},

			{pair: [[`aud`, `usd`], [0, .65833]]}, 
			{pair: [[`cad`, `usd`], [0, .72588]]}, 
			{pair: [[`eur`, `usd`], [0, 1.08008]]}, 
			{pair: [[`jpy`, `usd`], [0, .0063785]]},
