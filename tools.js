...
class Tools {
	...
	execute (Raw) {
		...
		let ts = new Date(`2024-06-13 10:45`).valueOf();
	...
	values (Raw) {
		...
		let Pairs = [
			...
			{pair: [[`eur`, `usd`], [0, 1.08139]]}, 
			{pair: [[`jpy`, `usd`], [0, .0063588]]},
			{pair: [[`kes`, `usd`], [0, .0077669]]},
			{pair: [[`nok`, `usd`], [0, .094389]]},
			{pair: [[`nzd`, `usd`], [0, .61787]]}, 
