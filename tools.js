...
class Tools {
	...
	values (Raw) {
		...
		let Pairs = [
			{pair: [[`btc`, `usd`], [0, 69507.94]]}, 
			{pair: [[`eth`, `usd`], [0, 3671.02]]}, 
			{pair: [[`ltc`, `usd`], [0, 79.48]]}, 
			{pair: [[`usdt`, `usd`], [0, 1.00019]]}, 
			{pair: [[`xmr`, `usd`], [0, 178.0421]]}, 
			{pair: [[`xrp`, `usd`], [0, .04960]]},

			{pair: [[`aud`, `usd`], [0, .65937]]}, 
			{pair: [[`cad`, `usd`], [0, .72602]]}, 
			{pair: [[`eur`, `usd`], [0, 1.07632]]}, 
			{pair: [[`jpy`, `usd`], [0, .0063692]]},
			{pair: [[`kes`, `usd`], [0, .0076922]]},
			{pair: [[`nok`, `usd`], [0, .093405]]},
			{pair: [[`nzd`, `usd`], [0, .61136]]}, 
			{pair: [[`zar`, `usd`], [0, .053233]]}, 
			{pair: [[`sek`, `usd`], [0, .094723]]},
			{pair: [[`gbp`, `usd`], [0, 1.27225]]}, 
			{pair: [[`chf`, `usd`], [0, 1.11500]]},
