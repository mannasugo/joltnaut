...
class Tools {
	...
	execute (Raw) {
		...
		let ts = new Date(`2024-06-10 03:48`).valueOf();
	...
	pairs (Raw) {
		...
		let Pairs = [{
			gas: 7.5/100,
			pair: [`btc/fdusd`, [69253.75, 69513.31]],
			ts_a: new Date(`2024-06-10 10:55`).valueOf(), 
			ts_z: new Date(`2024-06-10 11:05`).valueOf()
		}];
	...
	values (Raw) {
		...
		let Pairs = [
			{pair: [[`btc`, `usd`], [0, 69418.22]]}, 
			{pair: [[`eth`, `usd`], [0, 3702.34]]}, 
			{pair: [[`ltc`, `usd`], [0, 80.53]]}, 
			{pair: [[`usdt`, `usd`], [0, .99961]]}, 
			{pair: [[`xmr`, `usd`], [0, 171.8623]]}, 
			{pair: [[`xrp`, `usd`], [0, .049789]]},

			{pair: [[`aud`, `usd`], [0, .66141]]}, 
			{pair: [[`cad`, `usd`], [0, .72707]]}, 
			{pair: [[`eur`, `usd`], [0, 1.07920]]}, 
			{pair: [[`jpy`, `usd`], [0, .0063821]]},
			{pair: [[`kes`, `usd`], [0, .0076157]]},
			{pair: [[`nok`, `usd`], [0, .093216]]},
			{pair: [[`nzd`, `usd`], [0, .61051]]}, 
			{pair: [[`zar`, `usd`], [0, .052928]]}, 
			{pair: [[`sek`, `usd`], [0, .094959]]},
			{pair: [[`gbp`, `usd`], [0, 1.27199]]}, 
			{pair: [[`chf`, `usd`], [0, 1.11507]]},
