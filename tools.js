...
class Tools {
	...
	execute (Raw) {
		...
		let ts = new Date(`2024-06-10 11:02`).valueOf();
	...
	pairs (Raw) {
		...
		let Pairs = [{
			gas: 7.5/100,
			pair: [`btc/fdusd`, [69119.92, 69414.90]],
			ts_a: new Date(`2024-06-09 06:25`).valueOf(), 
			ts_z: new Date(`2024-06-09 10:01`).valueOf()
		}];
