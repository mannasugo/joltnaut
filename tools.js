...
class Tools {
	...
	execute (Raw) {
		...
		let ts = new Date(`2024-06-19 20:03`).valueOf();
	...
	pairs (Raw) {
		...
		let Pairs = [{
			...
			ts_a: new Date(`2024-06-21 09:51`).valueOf(), 
			ts_z: new Date(`2024-06-21 10:30`).valueOf()
		}];
	...
	values (Raw) {
		...
		let Pairs = [
			...
			{pair: [[`sek`, `usd`], [0, .095736]]},
			{pair: [[`gbp`, `usd`], [0, 1.27079]]}, 
			{pair: [[`chf`, `usd`], [0, 1.12412]]},
