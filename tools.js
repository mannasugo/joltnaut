...
class Tools {
	...
	pairs (Raw) {
		...
		let Pairs = [{
			gas: 7.5/100,
			pair: [`btc/fdusd`, [69042.62, 69325.31]],
			ts_a: new Date(`2024-05-25 15:03`).valueOf(), 
			ts_z: new Date(`2024-05-25 15:30`).valueOf()
		}];
	...
	values (Raw) {
		...
		let Pairs = [
			{pair: [[`btc`, `usd`], [0, 69177.56]]}, 
			{pair: [[`eth`, `usd`], [0, 3734.13]]}, 
			{pair: [[`ltc`, `usd`], [0, 84.81]]}, 
