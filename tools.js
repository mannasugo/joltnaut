...
class Tools {
	...
	pairs (Raw) {
		...
		let Pairs = [{
			gas: 7.5/100,
			pair: [`btc/fdusd`, [66862.91, 67371.02]],
			ts_a: new Date(`2024-05-24 10:03`).valueOf(), 
			ts_z: new Date(`2024-05-24 10:30`).valueOf()
		}];
	...
	values (Raw) {
		...
		let Pairs = [
			{pair: [[`btc`, `usd`], [0, 67027.79]]}, 
			{pair: [[`eth`, `usd`], [0, 3658.96]]}, 
			{pair: [[`ltc`, `usd`], [0, 84.72]]}, 
