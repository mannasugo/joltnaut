...
class Tools {
	...
	execute (Raw) {
		...
		let ts = new Date(`2024-05-27 06:08`).valueOf();
	...
	pairs (Raw) {
		...
		let Pairs = [{
			gas: 7.5/100,
			pair: [`btc/fdusd`, [68330.70, 68644.42]],
			ts_a: new Date(`2024-05-27 08:29`).valueOf(), 
			ts_z: new Date(`2024-05-27 09:05`).valueOf()
		}];
