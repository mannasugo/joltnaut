...
class Tools {
	...
	execute (Raw) {
		...
		let ts = new Date(`2024-06-12 10:39`).valueOf();
	...
	values (Raw) {
		...
		let Pairs = [
			{pair: [[`btc`, `usd`], [0, 67500.01]]}, 
			{pair: [[`eth`, `usd`], [0, 3524.58]]}, 
			{pair: [[`ltc`, `usd`], [0, 77.46]]}, 
			{pair: [[`usdt`, `usd`], [0, .99975]]}, 
			{pair: [[`xmr`, `usd`], [0, 177.26]]}, 
			{pair: [[`xrp`, `usd`], [0, .048096]]},
